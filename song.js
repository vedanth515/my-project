...
//     let song = await fetch("http://localhost:3000/song");
//     let songdata = await song.json();
//     allMovies = songdata; // Store the fetched data for searching

//     renderSongs(songdata); // Display all songs initially
// }

// // Function to render movie cards dynamically
...
//         songcart.style.borderRadius = "8px";
//         songcart.className = "mainCart";
//         songcart.innerHTML = `
//             <img src="${ele.songs[0].Album}" width="300px" height="300px"/>
//             <h4>${ele.moviename}</h4>
//         `;
...
// // Function to filter and display searched movies
...
//     renderSongs(filteredMovies); // Display only searched movie
// }
